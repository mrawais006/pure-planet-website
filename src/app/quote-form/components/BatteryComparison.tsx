...
export default function BatteryComparison({
  ...
  return (
    <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden">
      {/* Header */}
      <div className="bg-[#062d16] px-6 py-5 border-b border-white/10">
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-4 mt-2">
                <div className="w-16 h-16 bg-white/10 rounded-xl flex items-center justify-center">
                  <svg
                    className={`w-8 h-8 ${isRecommended ? "text-[#C2F32C]" : "text-gray-400"}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">{spec.bestFor}</p>
                </div>
              </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-white/10">
              <th className="py-4 px-6 text-left text-gray-400 font-medium w-1/4">
                Feature
              </th>
              <th
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-20 h-20 bg-white/10 rounded-xl flex items-center justify-center mb-2">
                    <svg
                      className={`w-10 h-10 ${recommendedBattery === "FoxESS" ? "text-[#C2F32C]" : "text-gray-400"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <span className="text-white font-bold">{foxESS.name}</span>
                </div>
              </th>
              <th
                className={`py-4 px-6 text-center w-[37.5%] ${
              ...
              >
                <div className="flex flex-col items-center">
                  ...
                  <div className="w-20 h-20 bg-white/10 rounded-xl flex items-center justify-center mb-2">
                    <svg
                      className={`w-10 h-10 ${recommendedBattery === "NeoVolt" ? "text-[#C2F32C]" : "text-gray-400"}`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <span className="text-white font-bold">{neoVolt.name}</span>
                </div>
              </th>
            </tr>
          </thead>
              ...
              >
                ...
                <td
                  className={`py-4 px-6 text-center text-white ${
                    recommendedBattery === "FoxESS" ? "bg-[#C2F32C]/5" : ""
                  }`}
                >
                ...
                <td
                  className={`py-4 px-6 text-center text-white ${
                    recommendedBattery === "NeoVolt" ? "bg-[#C2F32C]/5" : ""
                  }`}
                >
      ...
      <div className="p-6 bg-[#062d16]/50 border-t border-white/10">
        <div className="flex items-start gap-4">
          <div className="flex-shrink-0 w-12 h-12 bg-[#C2F32C]/20 rounded-xl flex items-center justify-center">
            <svg
