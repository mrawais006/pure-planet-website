    ...
    >
      ...
      <div className="text-center mb-10">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-6 py-3 mt-6"
        >
          <span className="text-gray-400">Reference:</span>
          <span className="text-[#C2F32C] font-bold text-lg">
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-10">
        ...
        >
          ...
          <h3
            className={`font-bold text-lg mb-1 ${
              result.rebateEligible ? "text-[#C2F32C]" : "text-yellow-500"
            }`}
          >
        ...
        >
          ...
          <p className="text-gray-400 text-sm">Estimated Daily Usage</p>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="bg-white/5 rounded-2xl border border-white/10 p-6 mt-8"
      >
        ...
        <div className="flex flex-wrap gap-3">
          {result.interestedSolar && (
            <div className="flex items-center gap-2 bg-[#C2F32C]/10 border border-[#C2F32C]/30 rounded-full px-4 py-2">
              <svg
          ...
          {result.interestedBattery && (
            <div className="flex items-center gap-2 bg-[#C2F32C]/10 border border-[#C2F32C]/30 rounded-full px-4 py-2">
              ...
              <span className="text-white font-medium">Battery Storage</span>
            </div>
          )}
          {result.interestedHeatpump && (
            <div className="flex items-center gap-2 bg-[#C2F32C]/10 border border-[#C2F32C]/30 rounded-full px-4 py-2">
              ...
              <span className="text-white font-medium">Heat Pump Hot Water</span>
            </div>
          )}
        </div>
      </motion.div>
      ...
      >
        ...
        <Link
          href="/"
          className="inline-flex items-center justify-center gap-2 bg-white/10 text-white font-bold py-4 px-8 rounded-xl
