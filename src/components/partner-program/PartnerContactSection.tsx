                ...
                <form className="space-y-6 max-w-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Abn number" className="w-full bg-white rounded-full py-3 px-6 text-sm focus:outline-none font-bold placeholder:text-gray-400" />
                        </div>
                    </div>

                    <div className="grid grid-cols-2 gap-4">
                        <input type="email" placeholder="Email" className="w-full bg-white rounded-full py-3 px-6 text-sm focus:outline-none font-bold placeholder:text-gray-400" />
                        <input type="text" placeholder="Phone Number" className="w-full bg-white rounded-full py-3 px-6 text-sm focus:outline-none font-bold placeholder:text-gray-400" />
                    </div>

                    <div className="flex items-center gap-2 text-xs font-bold text-secondary">
                        <input type="checkbox" id="terms_partner_section" className="rounded-sm" />
                        <label htmlFor="terms_partner_section" className="cursor-pointer">I agree to the Terms & Conditions</label>
                    </div>

                    <button className="bg-black text-white font-bold py-3 px-8 rounded-full hover:bg-white hover:text-black transition-all duration-300 flex items-center gap-2 text-sm w-fit uppercase tracking-wider">
                        Submit Enquiry
