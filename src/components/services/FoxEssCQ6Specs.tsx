            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">CQ6</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        Massive capacity energy storage designed for ease of installation and high reliability.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            title="Energy Range"
                            desc="Scaling from 11.98kWh up to 83.86kWh."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="Easy Installation"
                            desc="Streamlined setup for simpler commissioning."
                            icon={<ShieldIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Consistent performance backed by our 10-year warranty."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            ...
                            desc="Optimized for maximum energy retention and usage."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Completely protected against dust and water jets."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Scalable Design"
                            desc="Expand your system as your energy needs grow."
                            icon={<StackIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Nominal Capacity" value="11.98kWh" />
                        <SpecRow label="Max Capacity" value="83.86kWh" />
