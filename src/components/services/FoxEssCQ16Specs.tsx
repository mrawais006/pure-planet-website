            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">CQ16</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        Ultimate capacity and high-voltage performance for the most demanding energy storage requirements.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            ...
                            desc="Scaling from 64.28kWh up to 241.05kWh."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="High Voltage"
                            desc="Designed for superior efficiency and power handling."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Reliable, long-term operation guaranteed."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="relative h-[500px] lg:h-[600px] w-full order-1 lg:order-2 flex items-center justify-center">
                        <div className="relative w-full h-full">
                            ...
                            <Image
                                src="/fox-ess/CQ16.png"
                                alt="Fox ESS CQ16 Battery"
                                fill
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            ...
                            desc="Built to withstand rigorous usage cycles."
                            icon={<ShieldIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Completely sealed against elements."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Flexible Scalability"
                            desc="Configure specifically for your project needs."
                            icon={<StackIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Nominal Capacity" value="64.28kWh" />
                        <SpecRow label="Max Capacity" value="241.05kWh" />
                        ...
                        <SpecRow label="Installation" value="Floor Mount" />
...
export default FoxEssCQ16Specs;
