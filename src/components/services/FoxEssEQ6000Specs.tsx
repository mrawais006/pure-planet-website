            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">EQ6000 Plus</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        Maximized capacity for heavy users. The ultimate high-voltage commercial and large residential storage solution.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            ...
                            desc="Scalable up to 41.93kWh for maximum energy independence."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="High Voltage"
                            desc="High efficiency energy conversion with minimal loss."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Long-term peace of mind with our standard warranty."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="relative h-[500px] lg:h-[600px] w-full order-1 lg:order-2 flex items-center justify-center">
                        <div className="relative w-full h-full">
                            ...
                            <Image
                                ...
                                alt="Fox ESS EQ6000 Plus Battery"
                                fill
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            ...
                            desc="Advanced performance for demanding energy needs."
                            icon={<ShieldIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Durable construction suitable for indoor and outdoor installation."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Modular Design"
                            desc="Flexible configuration to meet your specific energy requirements."
                            icon={<StackIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Energy Range" value="11.98 ~ 41.93kWh" />
...
export default FoxEssEQ6000Specs;
