            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">EP5</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        A versatile high-voltage battery storage offering simplified installation and scalable energy capacity.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            ...
                            desc="Energy range from 5.18kWh up to 20.8kWh."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="Easy Installation"
                            desc="Designed for quick, hassle-free setup."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Reliability backed by a decade of comprehensive coverage."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="relative h-[500px] lg:h-[600px] w-full order-1 lg:order-2 flex items-center justify-center">
                        <div className="relative w-full h-full">
                            ...
                            <Image
                                src="/fox-ess/EP5.1.png"
                                alt="Fox ESS EP5 Battery"
                                fill
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            title="High Voltage"
                            desc="Efficient power management for modern homes."
                            icon={<ShieldIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Robust protection against water and dust ingress."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Flexible Mounting"
                            desc="Suitable for both floor and wall mounting options."
                            icon={<StackIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Nominal Capacity" value="5.18kWh" />
                        <SpecRow label="Scalability" value="Max 4 Modules (20.72kWh)" />
