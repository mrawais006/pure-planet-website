...
const FoxEssEQ5000Specs = () => {
    return (
        <section className="py-24 bg-white relative overflow-hidden text-[#062d16]">
            {/* Ambient Background Elements - Slight variation in position */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
                <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-[#C2F32C]/5 rounded-full blur-[100px]"></div>
                <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-[#062d16]/5 rounded-full blur-[100px]"></div>
            </div>
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">EQ5000</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        A high-performance, high-efficiency energy storage solution protecting your home against rising energy costs.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            title="Energy Range"
                            desc="Scalable capacity from 9.84kWh up to 29.52kWh."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="High Efficiency"
                            desc="Advanced high-voltage technology for minimal energy loss."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Reliable performance backed by a decade of coverage."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            title="Smart Design"
                            desc="Compact and stylish, blending seamlessly into any home."
                            icon={<StackIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Complete protection against dust and water for indoor or outdoor use."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Easy Installation"
                            desc="Plug-and-play design for quick and safe setup."
                            icon={<ShieldIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Nominal Capacity" value="9.84 ~ 29.52kWh" />
...
export default FoxEssEQ5000Specs;
