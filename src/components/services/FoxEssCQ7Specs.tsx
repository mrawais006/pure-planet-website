            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">CQ7</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        High-efficiency, scalable energy solution delivering consistent power for large applications.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            title="Energy Range"
                            desc="Scaling from 14.04kWh up to 98.28kWh."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="High Efficiency"
                            desc="Maximize your energy savings with industry-leading efficiency."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Long-term performance guaranteed."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            ...
                            desc="Stable power output for critical loads."
                            icon={<ShieldIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Durable casing for indoor or outdoor use."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Easy Integration"
                            desc="Simple connection to supported inverter systems."
                            icon={<StackIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Nominal Capacity" value="14.04kWh" />
                        <SpecRow label="Max Capacity" value="98.28kWh" />
