            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-[#062d16] mb-6">
                        Fox ESS <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C2F32C] to-green-600">EP12</span>
                    </h2>
                    <p className="text-gray-500 text-lg leading-relaxed">
                        A robust, safety-focused high-voltage battery system with impressive scalability.
                    </p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8 items-center mb-20">
                    ...
                    <div className="space-y-6 flex flex-col lg:items-end lg:text-right order-2 lg:order-1">
                        <SpecCard
                            title="Energy Range"
                            desc="Scalable from 11.52kWh up to 46.08kWh."
                            icon={<BatteryIcon />}
                        />
                        <SpecCard
                            title="Safety Reliable"
                            desc="Engineered with top-tier safety standards."
                            icon={<ShieldIcon />}
                        />
                        <SpecCard
                            title="10 Year Warranty"
                            desc="Peace of mind with our extensive warranty coverage."
                            icon={<BadgeIcon />}
                        />
                    </div>
                    ...
                    <div className="relative h-[500px] lg:h-[600px] w-full order-1 lg:order-2 flex items-center justify-center">
                        <div className="relative w-full h-full">
                            ...
                            <Image
                                src="/fox-ess/EP12.1.png"
                                alt="Fox ESS EP12 Battery"
                                fill
                    ...
                    <div className="space-y-6 flex flex-col lg:items-start lg:text-left order-3">
                        <SpecCard
                            ...
                            desc="Maximized energy output for your home."
                            icon={<BoltIcon />}
                        />
                        <SpecCard
                            title="IP65 Rated"
                            desc="Suitable for indoor and outdoor installations."
                            icon={<UmbrellaIcon />}
                        />
                        <SpecCard
                            title="Seamless Integration"
                            desc="Works perfectly with high-voltage hybrid inverters."
                            icon={<StackIcon />}
                        />
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-gray-50 rounded-3xl p-8 border border-gray-100">
                    ...
                    <div className="grid md:grid-cols-2 gap-x-12 gap-y-4 text-sm">
                        <SpecRow label="Nominal Capacity" value="11.52kWh" />
                        <SpecRow label="Max Capacity" value="46.08kWh" />
...
export default FoxEssEP12Specs;
